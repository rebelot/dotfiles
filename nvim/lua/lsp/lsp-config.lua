...
local on_attach = function(client, bufnr)
    ...
    buf_set_keymap('n', '<leader>lwl', '<cmd>lua print(table.concat(vim.lsp.buf.list_workspace_folders(), "; "))<CR>', opts)
    ...
    buf_set_keymap('n', '<leader>ld', '<cmd>lua vim.diagnostic.open_float(nil, {scope ="line", border = "rounded"})<CR>', opts)
