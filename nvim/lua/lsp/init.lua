...
local on_attach = function(client, bufnr)
    ...
    map({ "n", "x" }, "<leader>la", vim.lsp.buf.code_action, { desc = "LSP: Code Actions" })
    map("n", "<leader>ls", require("telescope.builtin").lsp_document_symbols, { desc = "LSP: document symbols" })
    map(
        "n",
        "<leader>lS",
    ...
    map({ "n", "i" }, "<C-q>", vim.lsp.buf.signature_help, { desc = "LSP: signature help" })
